...
CREATE TABLE IF NOT EXISTS documents (
    ...
    retention_data JSONB DEFAULT '[]'::JSONB, -- Datos de retención: [{userId, activa, motivo, fecha}]
    original_pdf_backup VARCHAR(1000), -- Ruta de backup del PDF original antes de cambios
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
...
-- Define los grupos disponibles para causación de facturas
-- ==================================================
...
-- Índices para causacion_integrantes
...
COMMENT ON COLUMN causacion_integrantes.user_id IS 'Referencia al usuario en la tabla users';
COMMENT ON COLUMN causacion_integrantes.cargo IS 'Cargo que aparecerá en el informe de firmas';
