      ...
      <div className="release-modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="release-modal-header">
          <div className="release-header-content">
            ...
            <h2>Liberar Factura Retenida</h2>
            <p className="release-instruction">
              ¿Estás seguro de que deseas liberar esta factura?
            </p>
          </div>
        ...
        <div className="release-modal-footer">
          <button className="release-btn-cancel" onClick={onClose} disabled={loading}>
            Cancelar
          </button>
          <button
            ...
            disabled={loading}
          >
            {loading ? 'Liberando...' : 'Liberar factura'}
          </button>
        </div>
      </div>
    </div>
