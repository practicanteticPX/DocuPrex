            ...
            <div style={{ position: 'relative' }}>
              <button
                ...
                style={{
                  ...
                  display: 'flex',
                  alignItems: 'center',
                  color: showSettings ? '#374151' : '#6b7280',
                  transition: 'all 0.2s',
                  borderRadius: '6px'
                }}
                onMouseEnter={(e) => { if (!showSettings) e.currentTarget.style.color = '#374151'; }}
                onMouseLeave={(e) => { if (!showSettings) e.currentTarget.style.color = '#6b7280'; }}
              >
