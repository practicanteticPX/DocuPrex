  ...
  const handleAddSignersToDocument = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        ...
        {
          query: `
            mutation AssignSigners($documentId: Int!, $userIds: [Int!]!) {
      ...
      const refresh = await axios.post(
        ...
        {
          query: `
            query GetSignatures($documentId: Int!) {
  ...
  const confirmRemoveSignerAction = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        ...
        {
          query: `
            mutation RemoveSigner($documentId: Int!, $userId: Int!) {
  ...
  const handleSaveOrder = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        ...
        {
          query: `
            mutation ReorderSigners($documentId: Int!, $newOrder: [Int!]!) {
